            ...
            <form method="POST" action="{{ route('admin.kampanyes.update', [$kampanye->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nama_kampanye') ? 'is-invalid' : '' }}" type="text"
                        name="nama_kampanye" id="nama_kampanye" value="{{ old('nama_kampanye', $kampanye->nama_kampanye) }}"
                        required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" type="number"
                            name="total" id="total" value="{{ old('total', $kampanye->total) }}" step="0.01"
                            required>
                        @if ($errors->has('total'))
                ...
                <div class="form-group">
                    <label for="image">{{ trans('cruds.kampanye.fields.image') }}</label><br/>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('lokasi') ? 'is-invalid' : '' }}" type="text"
                        name="lokasi" id="lokasi" value="{{ old('lokasi', $kampanye->lokasi) }}" readonly>
