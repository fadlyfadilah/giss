    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('koordinat_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.koordinats.index") }}" class="nav-link {{ request()->is("admin/koordinats") || request()->is("admin/koordinats/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-map-marked-alt">

                            </i>
                            <p>
                                {{ trans('cruds.koordinat.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
                @can('kampanye_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.kampanyes.index") }}" class="nav-link {{ request()->is("admin/kampanyes") || request()->is("admin/kampanyes/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-file-signature">

                            </i>
                            <p>
                                {{ trans('cruds.kampanye.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
